...
class Human():
    #初始化
    def __init__(self,mark,gameboard):
        self.id = 1
        self.mark = mark  #标记
...
class AI():
    ...
    def __init__(self,mark,gameboard):
        ...
        self.ele_weights = [15,6,-10,-4,8,8]
    ...
    def evaluation_best(self):
        ...
        #最终分数
        final_score = out_corner*self.ele_weights[0] + out_edge*self.ele_weights[1] + inner_corner*self.ele_weights[2]
